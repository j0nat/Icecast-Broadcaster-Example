...
{
    // Written by Zerpico
    // WRAPPER CLASS FOR libshout RETRIEVED FROM https://github.com/Zerpico/libShout-csharp
    // Modified to work with mono.
    ...
    public class Libshout
    {
        ...
        [DllImport("libshout.so", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport("libshout.so", CallingConvention = CallingConvention.Cdecl)]
